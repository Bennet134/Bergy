...
de: {
  ...
  standort_gerlingen_text:   "Gerlingen beherbergt unsere Lehrwerkstatt, in der Auszubildende an echten Maschinen ausgebildet werden. Gleichzeitig ergänzt der Standort die Produktionskapazitäten des Hauptwerks. Beide Standorte arbeiten nach identischen Qualitätsstandards und sind ISO 9001 sowie EN 9100 zertifiziert.",
  ...
  kar_moment2_cap:      "Teamevents die wirklich Spaß machen",
  kar_moment3_cap:      "Zusammen, nicht nebeneinander",
  kar_moment4_cap:      "Von Anfang an dabei, und nicht mehr wegzudenken",
  ...
  kon_hours_opening: "Mo – Fr · 08:00 – 17:00 Uhr",
  ...
  kar_btn_apply:      "Mehr erfahren",

  kar_job1_title: "Zerspanungsmechaniker (m/w/d)",
  kar_job1_desc:  "Hochpräzise spanende Bearbeitung komplexer Bauteile an modernen DMG-Bearbeitungszentren. Eigenverantwortliche Mehrmaschinenbedienung, Qualitätssicherung und aktive Mitwirkung im kontinuierlichen Verbesserungsprozess.",
  kar_job1_skills:["Abgeschlossene Ausbildung Zerspanungsmechaniker", "Erfahrung im Fräsen", "Qualitätsbewusstsein", "Eigenmotivation"],

  kar_job2_title: "Leiter Qualität / QMB (m/w/d)",
  kar_job2_desc:  "Fachliche und disziplinarische Führung eines 15-köpfigen Qualitätsteams. Verantwortung für Qualitätssicherung und QMS, Reklamationsmanagement, Auditbetreuung sowie Weiterentwicklung nach DIN ISO 9001 und EN 9100.",
  kar_job2_skills:["Technisches Studium / Qualitätssicherung", "Führungserfahrung", "QM-Methoden (8D, FMEA, SPC)", "Auditorausbildung"],

  kar_job3_title: "Mitarbeiter Reinraumfertigung (m/w/d)",
  kar_job3_desc:  "Montagearbeiten an feinmechanischen und mechatronischen Komponenten unter Reinraumbedingungen (ISO Klasse 6). Sicht- und Funktionsprüfungen sowie Einhaltung der Reinraum- und Qualitätsrichtlinien.",
  kar_job3_skills:["Ausbildung Metall / Mechatronik", "Hohe Feinmotorik", "Qualitätsbewusstsein", "Strukturierte Arbeitsweise"],
  ...
  kar_ausb_badge_start2027: "Start 2027",
  kar_ausb_badge_soon:      "Demnächst",
  kar_ausb_btn_apply:       "Jetzt bewerben",
  kar_ausb_btn_interest:    "Interesse bekunden",

  kar_ausb1_title: "Zerspanungsmechaniker (m/w/d)",
  kar_ausb1_text:  "Du lernst das Fertigen von Präzisionsbauteilen durch Drehen, Fräsen, Bohren und Schleifen. Du richtest Maschinen ein, überwachst den Fertigungsprozess und bist am Ende der Ausbildung in der Lage, eigenständig Werkstücke herzustellen.",

  kar_ausb2_title: "Industriemechaniker/in",
  kar_ausb2_text:  "Du hältst die Maschinen am Laufen: Montage, Wartung, Optimierung von Fertigungsanlagen. An beiden Standorten in Drolshagen und Wenden im Einsatz.",

  kar_ausb3_title: "Fachkraft für Lagerlogistik",
  kar_ausb3_text:  "Du koordinierst den Materialfluss von A bis Z: Wareneingang, Lager, Kommissionierung, Versand. Ohne dich steht die Produktion still.",

  kar_ausb4_title: "Industriekaufmann/frau",
  kar_ausb4_text:  "Du lernst das Unternehmen von innen kennen: Einkauf, Buchhaltung, Personal, Vertrieb, Logistik. Kein Bereich bleibt dir fremd.",
